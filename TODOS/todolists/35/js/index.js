...
function compileRoot(el, options, contextOptions) {
  ...
  if (el.nodeType !== 11) {
    ...
    if (names.length) {
      ...
      warn('Attribute' + (plural ? 's ' : ' ') + names.join(', ') + (plural ? ' are' : ' is') + ' ignored on component ' + '<' + options.el.tagName.toLowerCase() + '> because ' + 'the component is a fragment instance: ' + 'https://vuejs.org/guide/components.html#Fragment_Instance');
    }
  }
